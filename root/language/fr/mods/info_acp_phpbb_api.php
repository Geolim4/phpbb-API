...
//ACP hook management
	...
	'ACP_PHPBB_API_CONFIG_UMIL_PHP_OK'			=> 'Vous possédez PHP <strong>%s</strong> ou supérieur, vous pouvez continuer l’installation en toute sécurité.',
	...
	'ACP_PHPBB_API_CONFIG_UMIL_PCHART'			=> 'Librarie pChart',
	...
	'ACP_PHPBB_API_HOOK_INSTALLED'		=> 'Hooks installé',
	...
	'ACP_PHPBB_API_HOOK_UNINSTALLED'	=> 'Hooks non installé',
...
//API's Stats
	...
	'ACP_PHPBB_API_STATS_MONTH'			=> 'Statistiques mensuelle',
	'ACP_PHPBB_API_STATS_MONTH_REQ'		=> 'Requêtes/jour',
	'ACP_PHPBB_API_STATS_TOTAL'			=> '(%s requêtes totales)',
	'ACP_PHPBB_API_STATS_YEAR'			=> 'Statistiques annuelle',
...
//API's Logs
	...
	'API_LOG_API_LOGIN_ACCOUNT'		=> 'Connexion à son compte via l’API' . $api_lang_suffix,
	'API_LOG_BAD_AUTH_EMAIL'		=> '<strong>Authentification de la clé refusée:</strong><br />» E-mail utilisé :</strong> %s' . $api_lang_suffix,
	'API_LOG_BAD_AUTH_NO_EMAIL'		=> '<strong>Authentification de la clé refusée:</strong> Aucun email renseigné.' . $api_lang_suffix,
	...
	'API_LOG_BAN_IP'				=> '<strong>Bannissement d’une IP</strong><br />» %s' . $api_lang_suffix,
	'API_LOG_BAN_USER'				=> '<strong>Bannissement d’un utilisateur</strong><br />» %s' . $api_lang_suffix,
	'API_LOG_CLEAR'					=> '<strong>Journal de l’API purgé</strong><br />» %s message supprimé' . $api_lang_suffix,
	...
	'API_LOG_FATAL_ERROR'			=> '<strong>Une erreur fatale de PHP est survenue :</strong><br />»<code>%s</code>' . $api_lang_suffix,
	'API_LOG_NON_FATAL_ERROR'		=> '<strong>Une erreur du débogueur a été retournée :</strong><br />» %1$s' . $api_lang_suffix,
	...
	'API_LOG_RESYNC_STATS'			=> '<strong>Messages, sujets et statistiques d’utilisateurs resynchronisés</strong>' . $api_lang_suffix,
	...
	'API_LOG_UNBAN_IP'			=> '<strong>Débannissement d’une IP</strong><br />» %s' . $api_lang_suffix,
	...
	'ACP_PHPBB_API_BACKTRACE_EXP'		=> 'Cette option vous permettra de tracer les erreurs potentielles de l’API.
											<br />Notez que seules les clés des Administrateurs possèdent ce privilège.',
	...
	'ACP_PHPBB_API_DEACTIVATED_METHODS'	=> 'Méthodes désactivés',
	...
	'ACP_PHPBB_API_FAQ_MULTI_COLUMN'	=> 'Foire aux questions multi-colonnes',
	'ACP_PHPBB_API_FATAL_HTML'			=> 'Afficher les erreurs fatale au format HTML',
	'ACP_PHPBB_API_FATAL_HTML_EXP'		=> 'Si activé, l’API tentera de formater les erreurs fatales de PHP au format HTML plutôt qu’au format de sortie choisi l’utilisateur',
	'ACP_PHPBB_API_FORCE_LOGOUT'		=> 'Forcer la déconnexion',
	'ACP_PHPBB_API_FORCE_LOGOUT_EXP'	=> 'Pour plus de sécurité, chaque requête à l’API sera terminée par une déconnexion de la session. Cela impose néanmoins deux requêtes SQL supplémentaires par requête.',
	...
	'ACP_PHPBB_API_HEADER_EXP'		=> 'Si activé, le serveur renvoie un en-tête “<em>X-Powered-By: phpBB API/' . $config['api_mod_version'] . '</em>”',
	...
	'ACP_PHPBB_API_IGNORE_COUNTER'		=> 'Notez qu’il est possible d’ignorer ces limites avec des permissions d’utilisateurs.',
	...
	'ACP_PHPBB_API_KEY_FORCE_POST_EXP'		=> 'Cela empêchera la clé d’être utilisée autrement qu’en POST.',
	...
	'ACP_PHPBB_API_KEY_IPS_EXP'				=> 'Pour indiquer plusieurs adresses IPs ou noms d’hôtes différents, entrez chacun d’eux sur une nouvelle ligne. Pour indiquer une plage d’adresses IP, séparez le début et la fin par un tiret, et utilisez <strong>*</strong> comme caractère joker.',
	...
	'ACP_PHPBB_API_KEY_QUERY_SQL_API'		=> 'Requêtes SQL sur la table de stockage des clés API/logs',
	'ACP_PHPBB_API_KEY_QUERY_SQL_API_EXP'	=> 'Vous ne devriez accorder cette fonctionnalité seulement si vous avez une entière confiance au propriétaire de cette clé.
										<br />En effet, cette fonctionnalité étend les possibilités des requêtes SQL en autorisant celle-ci sur les tables de l’API ainsi que des logs.
	...
	'ACP_PHPBB_API_KEY_QUERY_SQL_EXP'		=> 'Soyez vigilant, cette fonctionnalité autorise la clé à effectuer n’importe quelle requête SQL, sauf sur les tables de l’API ainsi que celle des logs.',
	...
	'ACP_PHPBB_API_LEGEND_OUT_OF_QUOTA' => 'Clé hors quota',
	...
	'ACP_PHPBB_API_LOG_OFF'				=> '<strong>phpBB API désactivé pour cause d’installation incomplète.</strong><br />»Pour plus d’informations consultez phpBB API afin de voir les erreurs retournées.',
	'ACP_PHPBB_API_LOG_UPDATE'			=> 'Mise à jour du MOD phpBB API depuis la version <strong style="color: red;">%s</strong> vers <strong style="color: green;">%s</strong>',
	...
	'ACP_PHPBB_API_ERR_LOGS_HARD_EXP'	=> 'Le journal d’erreurs physique contient toutes les erreurs fatale y compris celle qui n’ont pu être enregistrés en base de données',
	'ACP_PHPBB_API_ERR_LOGS_PURGE'		=> 'Vider',
	'ACP_PHPBB_API_ERR_LOGS_PURGE_ERROR'=> 'Impossible de vider journal d’erreurs physique, fichier non accessible en écriture ou non verrouillable!',

	'ACP_PHPBB_API_MAX_QUERIES'			=> 'Nombre maximum total de requêtes',  // hummm... à revoir
	'ACP_PHPBB_API_MAX_QUERIES_SHORT'	=> 'Max. requêtes',
	...
	'ACP_PHPBB_API_MQ_EXPLAIN'			=> 'Saisir <strong>0</strong> pour désactiver cette restriction.',
	...
	'ACP_PHPBB_API_PCHART_CHECK'		=> 'Vérifier l’installation de pChart',
	...
	'ACP_PHPBB_API_TIME_TYPE'			=> 'Base de délai',
	...
	'ACP_PHPBB_API_TYPE_EXP'			=> 'Notez que les clés d’administrateur ne peuvent pas être gérées depuis le panneau de contrôle de l’utilisateur.', // ne faudrait il pas mettre "de type administrateur" ? 
	...
	'ACP_PHPBB_API_UPLOAD_HOOK_EXP'		=> 'Vous pouvez transférer ici une archive compressée d’un HOOK au format BertiX qui seras transférée décompressée dans le noyau de l’API.',
...
//Mod error
	...
	'ACP_PHPBB_API_ERR_NOCONST'			=> 'Constante <em>API_KEYS_TABLE</em> absente… Vérifiez le fichier « <strong>/includes/api/constants.php</strong> »',
...
//Version Check
	...
	'API_ERRORS_INSTRUCTIONS'			=> '<br /><h1>Utilisation de phpBB API v%1$s</h1><br />
										...
										Rendez-vous <strong><a href="%2$s" title="phpBB API">sur cette page</a></strong></p>
	...
	'API_ERRORS_NO_VERSION'				=> '<span style="color: red">La version du serveur n’a pas pu être contactée…</span>',
	...
	'API_ERRORS_VERSION_CHECK'			=> 'Vérificateur de Version du Mod phpBB API',
	'API_ERRORS_VERSION_CHECK_EXPLAIN'	=> 'Vérifie si la version de phpBB API que vous utilisez en ce moment est à jour.',
	...
	'API_ERRORS_VERSION_NOT_UP_TO_DATE'	=> 'Votre version de phpBB API n’est pas à jour.<br />Ci-dessous vous trouverez un lien vers l’annonce de sortie de la version la plus récente ainsi que des instructions sur la façon d’effectuer la mise à jour.',
	'API_ERRORS_VERSION_UP_TO_DATE'		=> 'Votre installation est à jour.',

	'API_LATEST_VERSION'				=> 'Dernière version',
	'API_NEW_VERSION'					=> 'Votre version de phpBB API n’est pas à jour. Votre version est la %1$s, la version la plus récente est la %2$s. Lisez la suite pour plus d’informations.',

	'API_UNABLE_CONNECT'				=> 'Impossible de récupérer la version du mod depuis le serveur, message d’erreur : %s',
	'API_UNABLE_CONNECT_HOOK'			=> 'Impossible de récupérer les version des hooks depuis le serveur, message d’erreur : %s',
));
